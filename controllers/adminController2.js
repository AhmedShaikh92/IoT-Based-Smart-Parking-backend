...
export const updateSlotStatus = async (req, res) => {
  try {
    ...
    if (status === 'free') {
      ...
      // Also complete any active booking for this slot so the user's ticket
      // is invalidated immediately (mirrors what unbookSlot does for the user).
      ...
      if (!activeBookingsSnap.empty) {
        ...
        activeBookingsSnap.docs.forEach((bookingDoc) => {
